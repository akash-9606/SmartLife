...
export default function AdminDashboard() {
  ...
  const validate = () => {
    ...
    if (!form.hospitalPlaceId.trim())
      errs.hospitalPlaceId = "Hospital Place ID is required";
      ...
      <div className="poa-main-content">
        ...
        <form className="poa-form" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            />
            {errors.email && (
              <small className="poa-error">{errors.email}</small>
            )}
          </div>
              ...
              <tr key={p._id || p.id}>
                ...
                <td data-label="Actions">
                  <div className="action-buttons">
                    <button
                      className="partner-action-button edit-button"
                      onClick={() => handleEdit(p)}
                    >
                      Edit
                    </button>
                    <button
                      className="partner-action-button delete-button"
